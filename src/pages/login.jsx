...
function handleKeyPress(event) {
  ...
  return (
    <div className='w-full h-screen  flex flex-col items-center  py-[3rem] '>
      ...
      <img className='lg:w-[7rem] lg:h-[7rem] sm:w-[23rem] w-[15rem] ' src="https://firebasestorage.googleapis.com/v0/b/antecedentes-chiapas.appspot.com/o/escudo.jpg?alt=media&token=40ec5ebe-5530-47ee-97d0-0f08fe836d00&_gl=1*g4g6zg*_ga*MTQ4NzE3MDk0NC4xNjkzOTUwNDk1*_ga_CW55HF8NVT*MTY5ODMzMjk5My40Ny4xLjE2OTgzMzM4MDguNS4wLjA." alt="" />
      <img className='lg:w-[20rem] lg:h-[7rem] sm:w-[23rem] w-[15rem] ' src="https://firebasestorage.googleapis.com/v0/b/antecedentes-chiapas.appspot.com/o/resto.png?alt=media&token=d7b3d22e-9ccf-4aa4-a5aa-a5f3867faf2b&_gl=1*1ovqfqz*_ga*MTQ4NzE3MDk0NC4xNjkzOTUwNDk1*_ga_CW55HF8NVT*MTY5ODMzMjk5My40Ny4xLjE2OTgzMzM5MDUuNjAuMC4w" alt="" />
      </div>
